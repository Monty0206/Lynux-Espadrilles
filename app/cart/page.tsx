      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-sand p-6">
          ...
          <div className="flex items-center gap-3 my-4">
            ...
            <span className="font-dm text-xs text-ink-light">or</span>
            <div className="flex-1 h-px bg-sand-dark" />
          </div>
          <button
            onClick={() => {
              const lines = cartItems.map(item => {
                ...
                return `• ${item.product.name} (${opts}) x${item.quantity} — R${item.product.price.toLocaleString('en-US', { minimumFractionDigits: 2 })}`
              }).join('\n')
